...
export const Storefront: React.FC = () => {
  ...
  return (
    <div style={{ paddingBottom: '80px' }}>
      ...
      <section style={{
        ...
        <div className="container" style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: '2.4rem', fontWeight: 800, lineHeight: 1.2, margin: 0, color: 'var(--text)', transition: 'all 0.3s ease' }}>
              {slides[activeSlide].title}
            </h2>
            <p style={{ color: 'var(--text-muted)', fontSize: '1.05rem', lineHeight: 1.6, margin: 0, height: '80px', overflow: 'hidden' }}>
              {slides[activeSlide].description}
            </p>
            
            <div style={{ display: 'flex', gap: '12px', marginTop: '12px' }}>
              <a href="#catalog" className="btn btn-primary" style={{ padding: '12px 24px', borderRadius: '10px' }}>
                לכל המוצרים בקטלוג
              </a>
              <button 
      ...
      {/* Catalog Filters */}
      <section id="catalog" className="container" style={{ marginBottom: '32px' }}>
        <div style={{
          display: 'flex',
          flexDirection: 'column',
          gap: '16px',
          ...
          <div style={{
            ...
            <span style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginLeft: '12px', display: 'flex', alignItems: 'center', gap: '6px' }}>
      ...
      <section className="container">
        {loading ? (
          ...
          <div style={{
            ...
            <p style={{ fontSize: '1.1rem', marginBottom: '16px' }}>לא נמצאו גאדג'טים התואמים לחיפוש שלך.</p>
